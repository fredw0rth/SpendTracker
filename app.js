...
function WeekPanel({ week, entries, credits, weeklyBudget, isLastWeek, onAddEntry, onDelEntry, onDelCredit, onEditEntry, onEditCredit }) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: { marginTop: 12 } },
            displayItems.map(item => item.kind === "split" ? (React.createElement("div", { key: item.id, style: S.splitGroup }, item.group.map((e, i) => React.createElement(EntryLine, { key: e.id, entry: e, onDel: () => handleDelete(e), onEdit: () => onEditEntry(e), grouped: true, last: i === item.group.length - 1 })))) : (React.createElement(EntryLine, { key: item.id, entry: item.entry, onDel: () => handleDelete(item.entry), onEdit: () => onEditEntry(item.entry) }))),
